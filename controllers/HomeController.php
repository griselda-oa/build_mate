...
class HomeController extends Controller
{
    ...
    public function index(): void
    {
        ...
        echo $this->view->render('Home/index-new', [
    ...
    public function dashboard(): void
    {
        ...
        try {
            ...
            $query = trim($_GET['q'] ?? '');
            // Support both 'cat' and 'category' parameters for flexibility
            $categoryId = !empty($_GET['cat']) ? (int)$_GET['cat'] : (!empty($_GET['category']) ? (int)$_GET['category'] : null);
