...
class ProductController extends Controller
{
    ...
    public function show(string $slug): void
    {
        ...
        if (Auth::check()) {
            ...
            // TEMPORARY: Allow all logged-in users to review for testing
            $canReview = !$reviewModel->hasReviewedProduct($userId, $productId);
            // TODO: Uncomment this line to require purchase before review:
            // $canReview = $hasPurchased && !$reviewModel->hasReviewedProduct($userId, $productId);
            
            // Check if user is in waitlist
            $isInWaitlist = $waitlistModel->isInWaitlist($userId, $productId);
    ...
    public function submitReview(): void
    {
        ...
        // TEMPORARY: Skip purchase verification for testing
        // TODO: Uncomment these lines to require purchase before review:
        /*
        ...
        */
        ...
        // TEMPORARY: Allow reviews without order ID for testing
        // Get order ID for this purchase (prefer product-specific, fallback to supplier)
        $orderId = null; // Set to null for testing
        // TODO: Uncomment these lines to require order:
        /*
        ...
        */
        ...
        // Note: reviews table only has: id, product_id, user_id, rating, comment, created_at
        $reviewModel->create([
