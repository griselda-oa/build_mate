...
$router->get('/contact.php', [HomeController::class, 'contact']);
$router->post('/contact', [HomeController::class, 'contact'], [CsrfMiddleware::class]);
$router->post('/contact.php', [HomeController::class, 'contact'], [CsrfMiddleware::class]);
...
$router->post('/admin/orders/{id}/delete', [AdminOrderController::class, 'delete'], [AuthMiddleware::class, RoleMiddleware::class . ':admin', CsrfMiddleware::class]);
