    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form id="contact-form" method="POST" action="../../index.phpcontact">
                        <?= \App\Csrf::field() ?>
                        <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const responses = {
        ...
        'supplier': 'To become a supplier, visit our supplier application page at ../../index.phpsupplier/apply. You\'ll need to submit your business documents for verification.',
