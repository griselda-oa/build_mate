...
<div class="container-fluid py-4">
    <div class="mb-3">
        <a href="<?= \App\View::relUrl('/admin/dashboard') ?>" class="back-button">
                        ...
                        <?php else: ?>
                            <?php foreach ($activeSessions as $session): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= \App\View::relUrl('/admin/chat/session/<?= urlencode($session['session_id']) ?>') ?>" class="btn btn-sm btn-primary">
