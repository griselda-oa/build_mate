...
<div class="supplier-dashboard-page">
    <div class="container">
        ...
        <div style="margin-bottom: 2rem;">
            <a href="<?= \App\View::relUrl('/supplier/advertisements/create') ?>" class="btn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; padding: 0.75rem 2rem; border-radius: 8px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">
        ...
        <?php if (empty($advertisements)): ?>
            <div class="section-card-modern">
                <div class="empty-state-modern" style="padding: 3rem 2rem;">
                    ...
                    <a href="<?= \App\View::relUrl('/supplier/advertisements/create') ?>" class="btn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; padding: 0.75rem 2rem; border-radius: 8px; font-weight: 600; text-decoration: none;">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: start; gap: 1rem; flex-wrap: wrap;">
                                    <div style="flex: 1; min-width: 200px;">
                                        ...
                                        <div style="color: #6B7280; font-size: 0.875rem; margin-bottom: 0.5rem;">
                                            Product: <a href="<?= \App\View::relUrl('/product/' . \App\View::e($ad['product_slug'] ?? '')) ?>" style="color: #667eea; text-decoration: none;"><?= \App\View::e($ad['product_name'] ?? 'N/A') ?></a>
                                        </div>
